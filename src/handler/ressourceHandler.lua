...
function ressourceHandler_loadTiles()
    ...
    imgData:paste(tileSource, 0, 0, 7 * tilesize, 4 * tilesize, tilesize, tilesize)
    tileset["rocks3"] = love.graphics.newImage(imgData)
    imgData:paste(tileSource, 0, 0, 8 * tilesize, 4 * tilesize, tilesize, tilesize)
    tileset["rocks4"] = love.graphics.newImage(imgData)
    ...
    charset["idle"] = love.graphics.newImage(imgData)
    charset["down0"] = love.graphics.newImage(imgData)
    imgData:paste(tileSource, 0, 0, 8, 0, 8, 12)
    charset["down1"] = love.graphics.newImage(imgData)
    imgData:paste(tileSource, 0, 0, 16, 0, 8, 12)
    charset["down2"] = love.graphics.newImage(imgData)
    imgData:paste(tileSource, 0, 0, 0, 12, 8, 12)
    charset["work0"] = love.graphics.newImage(imgData)
    ...
    charset["burn0"] = love.graphics.newImage(imgData)
    imgData:paste(tileSource, 0, 0, 8, 24, 8, 12)
    charset["burn1"] = love.graphics.newImage(imgData)
